...
export default function Shipping_order(props) {
    ...
    async function myfun() {
        ...
        if (!isFormValid) {
            ...
            if (!address.length && !country.length && !state.length && !zip.length && order_color.length) {
            ...
            try {
                let post_data = await fetch(`${BASE_API}/api/checkout`, {
                    method: "POST",
                    body: JSON.stringify({ customerId, name, address, country, state, zip, email, phone, order_note })
                });
        ...
        <div className="container" >
            <nav aria-label="breadcrumb">
                <ol className="breadcrumb mt-3">
                    ...
                    <li className="breadcrumb-item active" aria-current="page">Shipping Order</li>
                </ol>
            </nav>
            <div className="mt-2" >
            ...
            <div className="row my-3 gy-4">
                <div className="col-12 col-sm-12 col-lg-6 col-md-6 mb-md-0 ">
                    <h4 className="h3 mb-3 text-black">Billing Details</h4>
                    <div className="p-3 p-lg-5 border bg-white">
                        ...
                        <div className="form-group row mb-3">
                            <div className="col-md-12">
                                ...
                                <input
                                    ...
                                    className="form-control"
                                    value={address}
                                    style={{ border: `1px solid ${address_color}`, textTransform: 'capitalize' }}
                        ...
                        <div className="form-group row mb-3">
                            <div className="col-md-12">
                                ...
                                <input
                                    ...
                                    className="form-control"
                                    value={country}
                                    style={{ border: `1px solid ${country_color} `, textTransform: 'capitalize' }}
                        ...
                        <div className="form-group row mb-3 gy-3">
                            <div className="col-md-6">
                                ...
                                <input
                                    ...
                                    className="form-control"
                                    value={state}
                                    style={{ border: `1px solid ${state_color}`, textTransform: 'capitalize' }}
                        ...
                        <div className="form-group">
                            ...
                            <textarea
                                ...
                                value={order_note}
                                style={{ border: `1px solid ${order_color}`, textTransform: 'capitalize' }}
                ...
                <div className="col-12 col-sm-12 col-lg-6 col-md-6">
                    <div className="row mb-3">
                        <div className="col-md-12">
                            <h4 className="h3 mb-3 text-black">Coupon Code</h4>
                            <div className="p-3 p-lg-5 border bg-white">
                    ...
                    <div className="row mb-5">
                        <div className="col-md-12">
                            <h4 className="h3 mb-3 text-black">Your Order</h4>
                            <div className="p-3 p-lg-5 border bg-white">
